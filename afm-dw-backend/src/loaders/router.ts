...
import {employee_get,employee_get_all,employee_get_registered, employee_salarylist, employee_invoclist, employee_change_status, employee_put, employee_opvlist, employee_acsdata, employee_get_positions, employee_scud, employee_get_lates, employee_work_list, employee_get_access_department_list, employee_get_birthday, employee_get_lates_create_xls, employee_change_role, candidates_get_all, candidate_get, employees_get_all, employee_get_new } from '../controllers/employee';
...
export const routes = (app: express.Application) => {
    ...
    router.get('/candidates',candidates_get_all)
    router.get('/candidate/:id?',unCript, candidate_get) 
