...
export const routes = (app: express.Application) => {
    ...
    router.put('/employee/activate/:id', unCript, employee_activate);
    router.get('/registered/employees',employee_get_all)
    router.get('/registered/employee/:id', unCript, employee_get_registered);
