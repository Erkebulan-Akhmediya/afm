<template>
    ...
    <div class="adminUsers" v-if="true">
        <v-row>
            <v-col>
        ...
        <v-row>
            <v-col>
                <!-- <EmployeeTableSmallSearch 
                    @clickOnRow="selectEmployee" 
                    @changeEmployee="changeEmployee" 
                    :isAdmin="true" 
                    :employeeTable="searchEmployeeTable" 
...
<script>
import AdminEmployeeTable from '../components/AdminEmployeeTable.vue'
...
export default {
    ...
    methods: {
        ...
        async sendRole() {
            ...
            try {
                await this.axios.put(`/api/1.0/employee/:id`, {role_list}, {localParams})
    ...
    created() {
        ...
        console.log(this.searchEmployeeTable);
    },
}
</script>