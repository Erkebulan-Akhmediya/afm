...
import IQimage from "../components/IQimage.vue";
export default {
    ...
    async created() {
        try {
            ...
            this.useHeightBoxQuestion = (document.querySelector('body').clientHeight - document.getElementById('boxquestion').offsetTop);
      ...
      window.scrollTo({
        ...
        async getData(bind = {}) {
            try {
                ...
                this.useTests = data;
                console.log('ronaldo', this.useTests)
    ...
    return this.useTests.testSessionAnswer.map((_, index) => ({
      ...
      'default-color': !this.isQuestionAnswered(index),
        ...
        paginatedQuestions() {
            ...
            console.log('pag ', this.useTests.testSessionAnswer.slice(start, end).length)
                        ...
                        <v-sheet  
                            ...
                            <div v-if="question.questionTypeId == 3" :class="{ 'd-flex': !question.questionName.includes(' ') }">
                                <div v-if="!question.questionName.includes(' ')">
                                    <IQimage :questionName = question.questionName></IQimage>
                                </div>
                                <div v-else>
