...
export default {
  ...
  getters: {
    servicerequest_current_tab(state) {
      return state.servicerequest_current_tab;
    },
    SERVICEREQUEST_CATEGORIES(state) {
      return state.servicerequest_categories;
    },
    SERVICEREQUEST_SUBCATEGORIES(state) {
      return state.servicerequest_subcategories;
    },
    SERVICEREQUESTS_COUNT(state) {
      return state.servicerequests_count;
    },
    ...
    IS_SENDING_SERVICEREQUEST(state) {
      return state.is_sending_servicerequest;
    },
    PERFORMERS(state) {
