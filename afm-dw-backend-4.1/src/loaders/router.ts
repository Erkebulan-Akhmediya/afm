...
import {userRegister ,userLogin, userTokenRefresh, appConfig} from '../controllers/auth';
...
import {employee_get,employee_get_new,employees_get_all, candidates_get_all,candidate_get, employee_salarylist, employee_invoclist, employee_change_role, employee_change_status, employee_put, employee_opvlist, employee_acsdata, employee_get_positions, employee_scud, employee_get_lates, employee_work_list, employee_get_access_department_list, employee_get_birthday, employee_get_lates_create_xls} from '../controllers/employee';
...
import {doc_get, doc_getJbk, doc_getPen, doc_getExp, doc_getHoliday, get_holidays, pdf_workplace, pdf_summary
...
export const routes = (app: express.Application) => {
    ...
    // Activate user by id (ДСЮ)
    router.put('/employee/activate/:id', unCript, employee_change_status);
    router.get('/candidates',candidates_get_all) // /registered/employees
    router.get('/candidate/:id?',unCript, candidate_get) // /registered/employee/:id?

    router.get('/employees',employees_get_all) 
    router.get('/employee/:id?', unCript, employee_get_new);
    //router.get('/employee/:id?', unCript, employee_get);
    //router.get('/registered/candidate/:id?',unCript, employee_get_registered) 

    router.post('/reference/pdf_summary', pdf_summary); 
    router.put('/change_role/employee/:id', unCript, employee_change_role)
    ...
    // Reference endpoints for generating documents!!!
